...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    ('00000000-0000-0000-0000-000000000000', v_credential_id, 'authenticated', 'authenticated',
     'activity_log_user1@example.com', extensions.crypt('test-fixture-password', extensions.gen_salt('bf')), now(),
     '{"provider": "email", "providers": ["email"]}', '{}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', v_credential2_id, 'authenticated', 'authenticated',
     'activity_log_user2@example.com', extensions.crypt('test-fixture-password', extensions.gen_salt('bf')), now(),
     '{"provider": "email", "providers": ["email"]}', '{}', now(), now(), '', '', '', '');
