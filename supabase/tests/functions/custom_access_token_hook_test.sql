...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    '00000000-0000-0000-0000-000000000000', test_credential_id, 'authenticated', 'authenticated',
    'hook_test@example.com', extensions.crypt('test-fixture-password', extensions.gen_salt('bf')), now(),
