-- =============================================================
-- 1. UPDATE RLS policy: requires edit_cost_estimation permission
-- =============================================================
...
-- =============================================================
-- 2. Column-level update guard trigger
-- =============================================================
...
CREATE TRIGGER "trigger_check_cost_estimate_update_permissions"
  BEFORE UPDATE ON "cost_estimates"
  FOR EACH ROW
  EXECUTE FUNCTION check_cost_estimate_update_permissions();
